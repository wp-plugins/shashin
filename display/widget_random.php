...
<dt><label for="shashin_widget_random_title"><?php _e("Title", SHASHIN_L10N_NAME); ?>:</label></dt>
...
<dt><label for="shashin_widget_random_album_key"><?php _e("Album", SHASHIN_L10N_NAME); ?>:</label></dt>
...
<dt><label for="shashin_widget_random_max_size"><?php _e("Image Size", SHASHIN_L10N_NAME); ?>:</label></dt>
...
<dt><label for="shashin_widget_random_max_cols"><?php _e("Max Cols", SHASHIN_L10N_NAME); ?>:</label></dt>
...
<dt><label for="shashin_widget_random_how_many"><?php _e("No. of Images", SHASHIN_L10N_NAME); ?>:</label></dt>
...
<dt><label for="shashin_widget_random_caption_yn"><?php _e("Show Captions", SHASHIN_L10N_NAME); ?>:</label></dt>
...
<dt><label for="shashin_widget_random_float"><?php _e("CSS Float/Align", SHASHIN_L10N_NAME); ?>:</label></dt>
...
<dt><label for="shashin_widget_random_clear"><?php _e("CSS Clear", SHASHIN_L10N_NAME); ?>:</label></dt>

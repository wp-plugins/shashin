...
<dt><label for="shashin_widget_newest_title"><?php _e("Title"); ?>:</label></dt>
...
<dt><label for="shashin_widget_newest_album_key"><?php _e("Album"); ?>:</label></dt>
...
<dt><label for="shashin_widget_newest_max_size"><?php _e("Image Size"); ?>:</label></dt>
...
<dt><label for="shashin_widget_newest_max_cols"><?php _e("Max # of Columns"); ?>:</label></dt>
...
<dt><label for="shashin_widget_newest_how_many"><?php _e("# of Images"); ?>:</label></dt>
...
<dt><label for="shashin_widget_newest_caption_yn"><?php _e("Show Captions"); ?>:</label></dt>
...
<dt><label for="shashin_widget_newest_float"><?php _e("CSS Float"); ?>:</label></dt>
...
<dt><label for="shashin_widget_newest_clear"><?php _e("CSS Clear"); ?>:</label></dt>

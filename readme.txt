...
1. Go to the Shashin Settings menu and adjust the options as you like. Note the following in particular:
  ...
  * If you wish to display unlisted Picasa albums in Shashin, you need to provide your username and password in the Settings menu. Note that if you do not have unlisted albums, then do NOT enter your username and password (it makes the syncing more complex)
...
Please see [the Shashin page on my site](http://www.toppa.com/shashin-wordpress-plugin) for details on older versions.
